    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="users",
                        to="categories.healthinsurancecompany",
                    ),
                ),
                (
                    "roles",
                    models.ManyToManyField(
                        related_name="users", to="categories.RoleCategory"
                    ),
                ),
                (
                    "sex",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="+",
                        to="categories.locationaccessibilitycategory",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        to="categories.locationprogramcategory",
                    ),
                ),
                (
                    "region",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="memberships",
                        to="categories.membershipcategory",
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "photo",
                    common.thumbnails.ThumbnailImageField(upload_to="location_photos"),
                ),
                (
                    "location",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "online_link",
                    models.URLField(
                        blank=True, help_text="Vyplňte, pokud se událost koná online"
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="events",
                        to="categories.eventgroupcategory",
                    ),
                ),
                (
                    "intended_for",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="events",
                        to="categories.eventintendedforcategory",
                    ),
                ),
                (
                    "location",
                    models.ForeignKey(
                        blank=True,
                        help_text="Zobrazí se na webu jako místo konání akce",
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="events",
                        to="bis.location",
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="events_where_was_organizer",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
