    ...
    operations = [
        migrations.AlterField(
            ...
            field=tinymce.models.HTMLField(
                blank=True,
                help_text="Malá ochutnávka uvádí fotky, které k akci přiložíte. Popište fotky, které přikládáte nebo přibližte jak vypadaly akce na stejném místě v minulosti. U nových akcí můžete více ukázat místo a důvody proč vás oslovilo a představit organizátory.",
            ),
        ),
        migrations.AlterField(
            model_name="eventpropagation",
