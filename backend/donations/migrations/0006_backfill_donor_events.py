...
def backfill_donorevent(apps, schema_editor):
    ...
    # Použijeme rozbalení tuplu (objekt, _)
    event_type, _ = DonorEventCategory.objects.get_or_create(
        slug="recurrent_stopped",
        defaults={
    ...
    event_type, _ = DonorEventCategory.objects.get_or_create(
        slug="new_recurrent_pledge",
        defaults={"description": "Nový pravidelný dárce v Darujme"},
    )
    ...
    for year, quantifier in years.items():
        event_type, _ = DonorEventCategory.objects.get_or_create(
            ...
            defaults={
                "description": f"Pravidelný dárce daruje již {year} {quantifier}."
            },
        )
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("categories", "0017_create_donoreventcategory"),
    ]
