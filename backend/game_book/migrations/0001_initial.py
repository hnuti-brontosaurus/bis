            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="favourite_games", to=settings.AUTH_USER_MODEL
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="games",
                        to="game_book_categories.gamelengthcategory",
                    ),
                ),
                (
                    "location_category",
                    models.ManyToManyField(
                        related_name="games", to="game_book_categories.LocationCategory"
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="games",
                        to="game_book_categories.materialrequirementcategory",
                    ),
                ),
                (
                    "mental_category",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="games",
                        to="game_book_categories.mentalcategory",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="games",
                        to="game_book_categories.organizersnumbercategory",
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        related_name="games",
                        to="game_book_categories.ParticipantAgeCategory",
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        related_name="games",
                        to="game_book_categories.ParticipantNumberCategory",
                    ),
                ),
                (
                    "physical_category",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="games",
                        to="game_book_categories.physicalcategory",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="games",
                        to="game_book_categories.preparationlengthcategory",
                    ),
                ),
                (
                    "tags",
                    models.ManyToManyField(
                        related_name="games", to="game_book_categories.Tag"
                    ),
                ),
                (
                    "thumbs_up",
                    models.ManyToManyField(
                        related_name="thumbed_up_games", to=settings.AUTH_USER_MODEL
                    ),
                ),
                (
                    "watchers",
                    models.ManyToManyField(
                        related_name="watched_games", to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "games",
                    models.ManyToManyField(
                        related_name="game_lists", to="game_book.Game"
                    ),
                ),
                (
                    "owner",
