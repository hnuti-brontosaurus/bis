...
class OpportunitySerializer(ModelSerializer):
    ...
    def get_contact_name(self, instance) -> str:
        return instance.contact_name or (
            instance.contact_person and instance.contact_person.get_name()
        )

    def get_contact_phone(self, instance) -> str:
        return str(instance.contact_phone) or (
            instance.contact_person and str(instance.contact_person.phone)
        )

    def get_contact_email(self, instance) -> str:
        return instance.contact_email or (
            instance.contact_person and instance.contact_person.email
        )
